...
OBJECT_TEXT_ALIASES: Dict[str, List[str]] = {
    ...
    "Hem": ["hem", "hems", "curl", "curls", "opening", "openings"],
    "OpenHem": ["open hem", "open hems", "opening", "openings", "hem", "hems"],
    "ClosedHem": ["closed hem", "closed hems", "hem", "hems"],
    "RolledHem": ["rolled hem", "rolled hems", "curl", "curls", "opening", "openings", "hem", "hems"],
    "TearDropHem": ["teardrop hem", "teardrop hems", "tear drop hem", "tear drop hems", "curl", "curls", "opening", "openings", "hem", "hems"],
    ...
    "PartEdge": ["part edge", "part edges", "edge", "edges"],
    "Part Edge": ["part edge", "part edges", "edge", "edges"],
    "Hole": ["hole", "holes"],
